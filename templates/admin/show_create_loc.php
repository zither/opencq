...
<div class="w-full">
    ...
    <form class="bg-white rounded px-0 pt-2 mb-4" action="<?=$this->_l('cmd=create-loc&origin_mid=%d&direction=%s', $origin->id, $direction)?>" method="post">
        <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" name="info" >
        </div>
